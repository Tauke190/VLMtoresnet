    ...
    try:
        ...
        for epoch in range(NUM_EPOCHS):
            ...
            for i, (images, labels) in enumerate(train_loader):
                ...
                # --- Classifier loss, but detach backbone features ---
                classifier_outputs = classifier(student_features.detach())
                classifier_loss = nn.CrossEntropyLoss()(classifier_outputs, labels)

                # --- Only allow gradients from distillation loss to flow into backbone ---
